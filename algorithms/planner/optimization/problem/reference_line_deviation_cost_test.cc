...
TEST(ReferenceLineDeviationCostTest, CostComparisonTest) {
  ReferenceLineDeviationCost<Mfob> mfob_cost(
      kPathGain, kEndStateGain, ref_points, /*center_line_helper=*/nullptr);
  ReferenceLineDeviationCost<Tob> tob_cost(kPathGain, kEndStateGain, ref_points,
...
TEST(ReferenceLineDeviationCostTest, MfobSumGTest) {
  ReferenceLineDeviationCost<Mfob> cost(kPathGain, kEndStateGain, ref_points,
                                        /*center_line_helper=*/nullptr);
