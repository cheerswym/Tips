...
#ifndef ONBOARD_MATH_GEOMETRY_AABOX2D_H_
#define ONBOARD_MATH_GEOMETRY_AABOX2D_H_
...
class AABox2d {
 public:
   ...
   * @param center The center of the box.
   */
  AABox2d(double half_length, double half_width, Vec2d center);
...
inline AABox2d::AABox2d(const Vec2d &center, const double length,
                        const double width)
    : center_(center), half_length_(length / 2.0), half_width_(width / 2.0) {
  QCHECK_GT(half_length_, -kEpsilon);
  QCHECK_GT(half_width_, -kEpsilon);
}

inline AABox2d::AABox2d(const double half_length, const double half_width,
                        Vec2d center)
...
#endif  // ONBOARD_MATH_GEOMETRY_AABOX2D_H_
