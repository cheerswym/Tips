#ifndef ONBOARD_PERCEPTION_RANGE_IMAGE_RANGE_IMAGE_DENSE_CRF_CPU_H_
#define ONBOARD_PERCEPTION_RANGE_IMAGE_RANGE_IMAGE_DENSE_CRF_CPU_H_
...
class RangeImageDenseCRFCPU : public RangeImageDenseCRFBase {
 public:
  RangeImageDenseCRFCPU(const cv::Mat& semantic_image,
                        const cv::Mat& range_image,
                        const cv::Mat& intensity_image)
      : RangeImageDenseCRFBase(semantic_image, range_image, intensity_image) {}

  RangeImageDenseCRFCPU() = delete;
  ~RangeImageDenseCRFCPU() = default;
...
#endif  // ONBOARD_PERCEPTION_RANGE_IMAGE_RANGE_IMAGE_DENSE_CRF_CPU_H_
